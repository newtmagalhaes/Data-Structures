...
struct Node *lastNodeof(struct sCircularLinkedList *start)
{
...
unsigned sizeofLL(struct sCircularLinkedList *start)
{
  unsigned size = 0;
  if (!start->first)
  {
...
void showLL(struct sCircularLinkedList *start)
{
  struct Node *current = start->first;
  printf("start -> [ ");
  if (start->first)
...
void insertFirst(struct sCircularLinkedList *start, char data)
{
...
void insertLast(struct sCircularLinkedList *start, char data)
{
  struct Node *newNode = (struct Node *)malloc(sizeof(struct Node));
  if (!newNode)
  {
...
void insertAt(struct sCircularLinkedList *start, char data, unsigned position)
{
...
void deleteFirst(struct sCircularLinkedList *start)
{
  if (!start->first)
  {
    // case start-first equal NULL
...
void deleteLast(struct sCircularLinkedList *start)
{
  if (!start->first)
  {
    // case start-first equal NULL
...
void deleteAt(struct sCircularLinkedList *start, unsigned position)
{
  if (!start->first)
  {
    // case start->first equal NULL
...
int searchData(struct sCircularLinkedList *start, char data)
{
  struct Node *current = start->first;
  int position = 0,
      size = sizeofLL(start);
...
char searchPosition(struct sCircularLinkedList *start, unsigned position)
{
...
void freeLL(struct sCircularLinkedList *start)
{
...
void reverseLL(struct sCircularLinkedList *start)
{
